...
head(for_clust_data)
km1 = kmeans(for_clust_data, 4, nstart=200)
...
plot1<-ggplot(data=df, aes(x=CI2, y=CI1, color=cluster )) + 
...
plot2<-ggplot(for_clust_data, aes(CI2, CI1, color = Campus2017Rating)) + geom_point()
